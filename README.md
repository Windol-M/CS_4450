...
6. Test Your Own Files
    You can see the parse tree by running the script Deliverable3_main.py. It prints a string tree to the terminal and additionally puts the string tree into a file in your current directory. First, open Deliverable3_main.py and change the input file at the top to be the path to the test file. Then run: python Deliverable3_main.py. Or hit the run button in your text editor/IDE with the main python file selected.
